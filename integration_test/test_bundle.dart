...
import 'flows/artist/update_delete_work_test.dart' as flows__artist__update_delete_work_test;
import 'flows/artist/update_work_test.dart' as flows__artist__update_work_test;
import 'flows/artist/add_stencil_test.dart' as flows__artist__add_stencil_test;
import 'flows/artist/add_work_test.dart' as flows__artist__add_work_test;
import 'flows/artist/delete_work_test.dart' as flows__artist__delete_work_test;
...
Future<void> main() async {
  ...
  group('flows.artist.update_delete_work_test', flows__artist__update_delete_work_test.main);
  group('flows.artist.update_work_test', flows__artist__update_work_test.main);
  group('flows.artist.add_stencil_test', flows__artist__add_stencil_test.main);
  group('flows.artist.add_work_test', flows__artist__add_work_test.main);
  group('flows.artist.delete_work_test', flows__artist__delete_work_test.main);
