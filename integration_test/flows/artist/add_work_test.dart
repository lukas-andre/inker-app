...
void main() {
  patrolTest(
    'Artist can add a new work with tag',
    ...
    ($) async {
      ...
      final workTitle =
          'Amazing Tattoo Work ${DateTime.now().millisecondsSinceEpoch}';
      const workDescription =
          'A detailed tattoo work for automated testing.';

      final success = await WorkTestActions.addWork(
        $,
        title: workTitle,
