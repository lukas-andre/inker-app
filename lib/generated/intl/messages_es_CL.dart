...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m13(hoursv2) => "${hoursv2} horas";

  static String m14(distance) => "Distancia máxima: ${distance} km";

  static String m15(preview) => "Mensaje: ${preview}";
