...
class RegisterCustomerPhoneNumberInput extends StatelessWidget {
  RegisterCustomerPhoneNumberInput({Key? key}) : super(key: key);
  final _texEditingController = TextEditingController();

  @override
  Widget build(BuildContext context) {
    final phoneNumber =
        context.read<RegisterCustomerBloc>().state.form.phoneNumber;
        ...
        return CustomPhoneNumberInput(
          ...
          onInputChanged: (number) {
            context.read<RegisterCustomerBloc>().add(
                  RegisterCustomerPhoneNumberChanged(PhoneNumber(
          ...
          suffixIcon: state.form.phoneNumber.value.phoneNumber.isNotEmpty
              ? ClearInput(
                  onTap: () {
                    ...
                    context.read<RegisterCustomerBloc>().add(
                          const RegisterCustomerPhoneNumberChanged(PhoneNumber(
