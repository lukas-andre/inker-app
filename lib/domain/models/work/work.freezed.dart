...
abstract class $TagCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String? createdBy, int? count});
}
...
class _$TagImpl implements _Tag {
  const _$TagImpl(
      {required this.id, required this.name, this.createdBy, this.count});
  ...
  @override
  String toString() {
    return 'Tag(id: $id, name: $name, createdBy: $createdBy, count: $count)';
  }
